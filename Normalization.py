...
users = pd.read_csv(usersFile,usecols=['Page_Rank','Hub','Authority','Similarity','No_of_post','length_in_comment','updatness'])
...
df_post = pd.DataFrame(dataSet, columns=['Page_Rank','Hub','Authority','Similarity','No_of_post','length_in_comment','updatness'])
